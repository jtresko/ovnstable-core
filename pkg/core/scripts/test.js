...
async function main() {
    ...
    let pool = await hre.ethers.getContractAt(require('./abi/IUniswapV3Pool.json'), '0x6a8fc7e8186ddc572e149dfaa49cfae1e571108b');
    let strategy = await hre.ethers.getContractAt(require('./abi/DefiEdgeTwapStrategy.json'), '0x0772a1119bbd71532baf45a611825d27b0869fd3');
