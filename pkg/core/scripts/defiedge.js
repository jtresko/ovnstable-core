...
async function main() {
    ...
    // uncomment for USD+
    let strategy = await hre.ethers.getContractAt(DefiEdgeTwapStrategy, "0xD1C33D0AF58eB7403f7c01b21307713Aa18b29d3");
    let usdPlusToken = await getContract('UsdPlusToken', 'optimism');
    let asset = await getERC20('usdc');
    let amount = toE6(1);

    // uncomment for DAI+
//    let strategy = await hre.ethers.getContractAt(DefiEdgeTwapStrategy, "0x014b7eedbb373866f2fafd76643fdf143ef39960");
