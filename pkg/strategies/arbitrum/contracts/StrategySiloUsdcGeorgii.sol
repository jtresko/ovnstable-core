...
contract StrategySiloUsdcGeorgii is Strategy {
    // --- params
    ...
    function _stake(address _asset, uint256 _amount) internal override {
        if (address(underlyingAsset) == address(usdc)) {
            console.log("StrategySiloUsdcGeorgii._stake:");
        ...
        console.log("StrategySiloUsdcGeorgii._stake: asset not USDC: ", address(underlyingAsset));
        console.log("amount: ", _amount);
        console.log("underlyingAsset amount: ", underlyingAsset.balanceOf(address(this)));
        console.log("usdc amount: ", usdc.balanceOf(address(this)));
        ...
        console.log("to deposit : ", underlyingBalance);
