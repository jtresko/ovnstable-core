...
contract StrategyGeorgii is Strategy {
    ...
    function netAssetValue() external view override returns (uint256) {
        console.log("CONTRACT -- netAssetValue()");
        console.log("usdc:", usdcToken.balanceOf(address(this)));
        console.log("aUsdcToken:", aUsdcToken.balanceOf(address(this)));
