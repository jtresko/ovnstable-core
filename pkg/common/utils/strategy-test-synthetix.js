...
const { transferAsset, getERC20, transferETH, initWallet, execTimelock, getContract } = require("./script-utils");
const ERC20 = require("./abi/IERC20.json");
const { Roles } = require("./roles");
const { BASE } = require("./assets");


function strategyTestSynthetix(strategyParams, network, assetName, runStrategyLogic) {
            ...
            describe(`Stake ${stakeValue}`, function () {
                ...
                describe(`UnStake ${unstakeValue}`, function () {
                    ...
                    sharedBeforeEach(`Unstake ${unstakeValue}`, async () => {
                        ...
                        await strategy.connect(recipient).prepareUnstake(assetValue);
...
async function setUp(network, strategyParams, assetName, runStrategyLogic) {
    ...
    const strategy = await getContract(strategyName, 'localhost');
...
module.exports = {
    strategyTestSynthetix: strategyTestSynthetix,
}
